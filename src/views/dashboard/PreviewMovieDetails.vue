<template>
  ...
  >
    <v-row justify="center">
      ...
      >
        ...
        >
          ...
          <v-card-text>
            ...
            <v-row
              class="mt-5"
              v-if="allMovies.description != 'undefined'"
            >
              <v-col>
              ...
              >
                <template v-for="star in allMovies.actor">
                  <v-chip
                    ...
                    class="ml-0 mr-2 blue-grey--text text-capitalize font-weight-bold"
                    label
                    small
                  >
                    {{ star }}
          ...
          <v-card-actions class="mt-5">
            <v-btn
              ...
              height="60"
              class="px-5 text-capitalize body-1"
            ...
            <v-btn
              depressed
              @click="addMovie(allMovies._id)"
              height="60"
              class="px-5 text-capitalize body-1"
              color="amber"
            > Add to Shoplist </v-btn>
          </v-card-actions>
          <v-row>
            <v-col>
      ...
      >
        <app-image
          :image="getThumbnail(allMovies.image)"
          position="top left"
          contain
        ></app-image>
          ...
          <v-col>
            ...
            >
              ...
              >
                ...
                >
                  <v-card
                    :to="{ name: 'PreviewMovieDetails', params: { movieId: movie._id } }"
                    class="ma-2 "
                    height="180"
                    width="230"
                    elevation="1"
